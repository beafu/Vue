      ...
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="基本信息" name="first">
          <div class="jiben">
            ...
            <el-form-item label="商品名称" prop="goodsname">
              <el-input placeholder="请输入商品名称" v-model="formDate.goodsname"></el-input>
            </el-form-item>
            <el-form-item label="商品价格" prop="price">
              <el-input placeholder="请输入商品价格" v-model="formDate.price"></el-input>
            </el-form-item>
            <el-form-item label="市场价格" prop="market_price">
              <el-input placeholder="请输入市场价格" v-model="formDate.market_price"></el-input>
            </el-form-item>
        ...
        <el-tab-pane label="详细描述" name="second">
          <el-form-item label-width="0" prop="description">
            <vue-wangeditor id="editor" ref="editor" width="100%" style="height:500px" v-model="formDate.description"></vue-wangeditor>
          </el-form-item>
        </el-tab-pane>
      </el-tabs>
      <el-form-item>
...
export default {
  ...
  methods: {
    ...
    async getList(){
      const res=await axios.all([getCategoryList(),getspecList()])
      if(res){
        [this.firatList,this.specsidList]=res
      }
    }
  },
};
